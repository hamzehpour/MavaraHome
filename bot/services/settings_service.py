...
EDITABLE_SETTINGS = {
    ...
    # Rest of pages/companionship.html + all of pages/podcast.html —
    # unlike the resume page's photo/link-list (which needed real upload
    # and add/remove widgets, so got a dedicated box on pages/admin/
    # portfolio.html), every one of these is a plain text/URL field with
    # a fixed count, so the existing generic settings-page renderer
    # (pages/admin/settings.html) already handles it with zero new code —
    # just two more entries in its SECTIONS list.
    "content_companion_eyebrow": "زیرعنوان بالای صفحه «همراهی»",
    "content_companion_title": "عنوان اصلی صفحه «همراهی»",
    "content_companion_sub": "زیرعنوان صفحه «همراهی»",
    "content_companion_h3": "عنوان بالای لیست «این جلسات مناسب کسانی است که:»",
    "content_companion_li1": "آیتم اول لیست",
    "content_companion_li2": "آیتم دوم لیست",
    "content_companion_li3": "آیتم سوم لیست",
    "content_companion_li4": "آیتم چهارم لیست",
    "content_companion_note": "خط توضیح نحوه‌ی برگزاری",
    "content_companion_cta_text": "متن دکمه‌ی هماهنگی",
    "content_companion_cta_url": "لینک دکمه‌ی هماهنگی",
    "content_podcast_eyebrow": "زیرعنوان بالای صفحه «پادکست»",
    "content_podcast_title": "عنوان اصلی صفحه «پادکست»",
    "content_podcast_sub": "زیرعنوان صفحه «پادکست»",
    "content_podcast_intro": "پاراگراف معرفی پادکست (می‌تواند شامل <strong> باشد)",
    "content_podcast_castbox_url": "لینک کست‌باکس",
    "content_podcast_apple_url": "لینک اپل پادکست",
    "content_podcast_ig_desc": "آیدی اینستاگرام پادکست (نمایشی)",
    "content_podcast_ig_url": "لینک اینستاگرام پادکست",
    "content_podcast_support_eyebrow": "زیرعنوان بخش «حمایت»",
    "content_podcast_support_title": "عنوان بخش «حمایت»",
    "content_podcast_host": "خط «میزبان و سازنده»",
    "content_podcast_card_label": "برچسب شماره کارت",
    "content_podcast_card_number": "شماره کارت حمایت از پادکست",
...
CONTENT_KEYS = [
    ...
    "content_companion_li3", "content_companion_li4", "content_companion_note", "content_companion_cta_text",
    "content_companion_cta_url",
    "content_podcast_eyebrow", "content_podcast_title", "content_podcast_sub", "content_podcast_intro",
    "content_podcast_castbox_url", "content_podcast_apple_url", "content_podcast_ig_desc",
    "content_podcast_ig_url", "content_podcast_support_eyebrow", "content_podcast_support_title",
    "content_podcast_host", "content_podcast_card_label", "content_podcast_card_number",
...
SETTINGS_FIELD_TYPES: dict[str, str] = {
    ...
    "content_companion_h3": "text",
    "content_companion_li1": "text",
    "content_companion_li2": "text",
    "content_companion_li3": "text",
    "content_companion_li4": "text",
    "content_companion_note": "text",
    "content_companion_cta_text": "text",
    "content_companion_cta_url": "text",
    "content_podcast_eyebrow": "text",
    "content_podcast_title": "text",
    "content_podcast_sub": "text",
    "content_podcast_intro": "textarea",
    "content_podcast_castbox_url": "text",
    "content_podcast_apple_url": "text",
    "content_podcast_ig_desc": "text",
    "content_podcast_ig_url": "text",
    "content_podcast_support_eyebrow": "text",
    "content_podcast_support_title": "text",
    "content_podcast_host": "text",
    "content_podcast_card_label": "text",
    "content_podcast_card_number": "text",
